        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-80 bg-gray-900 border-r border-gray-800 overflow-y-auto">
            ...
            <div className="p-3 space-y-1">
              ...
              <button onClick={() => handleLessonChange("knowledge-check", false)} className={`w-full text-left px-3 py-2 rounded text-sm transition-colors ${currentLesson === "knowledge-check" ? "bg-[#005691] text-white" : "hover:bg-gray-800 text-gray-300"}`}>
                <div className="flex items-center gap-2 mb-1">
